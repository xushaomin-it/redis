package com.xsm.redis.config;

import com.xsm.redis.topic.MessageReceiveOne;
import com.xsm.redis.topic.MessageReceiveTwo;
...
public class MyRedisConfig {
    ...
    @Bean
    public RedisMessageListenerContainer container(RedisConnectionFactory connectionFactory, MessageListenerAdapter listenerAdapter2, MessageListenerAdapter listenerAdapter) {
